...
startTheROS2Loop =  function(){ros2Loop = setInterval(startROS, 1000);}; 
...
function startROS(){
  if(registered_devices_count>0){
    ...
    rclnodejs.init().then(() => {
      ...
      startTheAgentBridge = function(){ros2DiscoveryLoop = setInterval(startTheBridge, 1000);}; 
    });
  }
  else{
